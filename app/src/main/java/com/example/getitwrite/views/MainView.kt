...
@Composable
fun MainView(logoutNavController: NavHostController, navController: NavController, proposals: List<Proposal>, selectProposal: (Proposal) -> Unit, selectChat: (String, String) -> Unit, user: User) {
