...
class User(
    ...
    var frequencey: Double? = null,
    var critiquerExpected: String? = null,
    ...
    constructor(id: String, data: Map<String, Any>) : this (
        ...
        frequencey = data.get("frequencey") as Double?,
        critiquerExpected = data.get("critiquerExpected") as String?,
    )
}